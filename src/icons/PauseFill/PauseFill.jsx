...
export const PauseFill = ({ className }) => {
  return (
    <svg
      className={`pause-fill ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
